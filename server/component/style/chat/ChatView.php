...
abstract class ChatView extends StyleView
{
    ...
    public function get_js_includes($local = array())
    {
        if (empty($local)) {
            if (DEBUG) {
                $local = array(__DIR__ . "/js/chat.js");
            } else {
                $local = array(__DIR__ . "/../../../../js/ext/chat.min.js?v=" . rtrim(shell_exec("git describe --tags")));
            }
        }
    ...
    public function get_css_includes($local = array())
    {
        if (empty($local)) {
            if (DEBUG) {
                $local = array(__DIR__ . "/css/chat.css");
            } else {
                $local = array(__DIR__ . "/../../../../css/ext/chat.min.css?v=" . rtrim(shell_exec("git describe --tags")));
            }
        }
